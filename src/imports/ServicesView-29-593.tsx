import svgPaths from "./svg-ia4e35as2o";
  ...
  return (
    <div className="content-stretch flex flex-col items-start leading-[0] not-italic relative shrink-0 text-[#003630] w-[101px]">
      <div className="font-['IBM_Plex_Sans_Devanagari:SemiBold',_sans-serif] h-[19px] relative shrink-0 text-[17px] tracking-[-0.17px] w-full">
        <p className="leading-[24px]">ZMW 1500</p>
      </div>
  ...
  return (
    <div className="basis-0 content-stretch flex gap-[51px] grow items-center justify-center min-h-px min-w-px relative shrink-0">
      <div className="font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[14px] text-black w-[80px]">
        <p className="leading-[1.4]">ZMW 1500</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center left-1/2 overflow-clip px-[24px] py-[10px] rounded-[6px] top-[478px] translate-x-[-50%] w-[276px]" data-name="Button">
