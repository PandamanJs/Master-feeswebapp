import svgPaths from "./svg-oumy2vj4w7";
...
function Button1() {
  return (
    <div className="absolute bg-[#95e36c] box-border content-stretch flex gap-[8px] h-[42px] items-center justify-center overflow-clip px-[24px] py-[10px] rounded-[10px] top-[432px] translate-x-[-50%] w-[283px]" data-name="Button" style={{ left: "calc(50% - 0.5px)" }}>
...
function Frame30175() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[241px] items-start left-1/2 overflow-clip rounded-[15px] top-[175px] translate-x-[-50%] w-[278px]">
      <Frame30173 />
    </div>
  );
}
