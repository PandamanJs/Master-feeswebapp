import svgPaths from "./svg-fblj0dx1cw";
    ...
    <div className="relative shrink-0 size-[100px]" data-name="Warning / Circle_Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 100 100">
        <g id="Warning / Circle_Check">
          <path d={svgPaths.p174b1c80} id="Vector" stroke="var(--stroke-0, #95E36C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6" />
        </g>
      </svg>
    </div>
  );
...
function Frame1707478895() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#d7dee1] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]" />
      <div className="flex flex-col items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-center justify-center pb-[36px] pt-[24px] px-[24px] relative w-full">
          <WarningCircleCheck />
          <div className="font-['Inter:Extra_Light',_sans-serif] font-extralight leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap tracking-[-0.16px]">
            <p className="leading-[24px] whitespace-pre">Payment Success</p>
          </div>
          <div className="font-['IBM_Plex_Sans_Devanagari:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[32px] text-black text-nowrap tracking-[-0.32px]">
            <p className="leading-[24px] whitespace-pre">K8,336.25</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame1707478897() {
  return (
    <div className="content-stretch flex font-['IBM_Plex_Sans_Devanagari:Medium',_sans-serif] gap-[16px] items-start leading-[0] not-italic relative shrink-0 text-[#003630] text-[16px] text-nowrap tracking-[-0.16px]">
      ...
      <div className="relative shrink-0">
        <p className="leading-[24px] text-nowrap whitespace-pre">000064431467</p>
      </div>
    </div>
  );
}
...
function Frame1707478896() {
  return (
    <div className="bg-[#e0f7d4] relative rounded-[16px] shrink-0 w-full">
...
function Button() {
  return (
    <div className="bg-[#003630] h-[59px] relative rounded-[12px] shrink-0 w-full" data-name="Button">
...
function Frame1707478902() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center translate-x-[-50%] translate-y-[-50%] w-[368px]" style={{ top: "calc(50% + 0.5px)", left: "calc(50% + 0.5px)" }}>
      <Frame1707478895 />
      <Frame1707478896 />
      <Frame1707478901 />
    </div>
...
export default function DownloadReceipt() {
  return (
    <div className="bg-white relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="download receipt">
      <Frame1707478902 />
    </div>
  );
}