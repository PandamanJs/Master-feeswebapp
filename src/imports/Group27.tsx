...
import svgPaths from "./svg-9zl2ahwc6s";
...
function Frame3({ onBack }) {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[24px] items-center justify-start left-0 top-0 w-[297px]">
...
function Button({ onClick, children, className = "" }) {
  return (
    <button 
      onClick={onClick}
      className={`bg-[#003630] box-border content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[24px] py-[10px] relative rounded-[12px] shrink-0 w-[297px] hover:bg-[#004840] active:scale-95 transition-all ${className}`} 
      data-name="Button"
    >
...
function Frame32({ onPaySchoolFees }) {
  return (
    <div className="absolute content-stretch flex gap-[15px] h-[44px] items-start justify-start left-[31px] top-[193px] w-[297px]">
      <Button onClick={onPaySchoolFees}>Pay for School Fees</Button>
    </div>
  );
}
...
function Frame33({ onViewBalances }) {
  return (
    <div className="absolute content-stretch flex gap-[15px] h-[44px] items-start justify-start left-[31px] top-[248px] w-[296px]">
      <SecondaryButton onClick={onViewBalances}>View/Clear Current Balances</SecondaryButton>
    </div>
  );
}
...
function Frame34({ onViewHistory }) {
  return (
    <div className="absolute content-stretch flex gap-[15px] h-[43px] items-start justify-start left-[31px] top-[304px] w-[296px]">
      <SecondaryButton onClick={onViewHistory}>View my Payment History</SecondaryButton>
    </div>
  );
}
...
function Frame35({ onViewPlans }) {
  return (
    <div className="absolute content-stretch flex gap-[15px] h-[44px] items-start justify-start left-[31px] top-[359px] w-[296px]">
      <SecondaryButton onClick={onViewPlans}>View School Payment plans</SecondaryButton>
    </div>
  );
}
...
function Group26({ userName, onBack, onPaySchoolFees, onViewBalances, onViewHistory, onViewPlans }) {
  ...
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute font-['IBM_Plex_Sans_Devanagari:Regular',_sans-serif] h-[46px] leading-[0] left-[31px] not-italic text-[12px] text-black top-[123px] tracking-[-0.12px] w-[296px]">
        <p className="leading-[1.5]">Which one of our services would you like us to help you with today?</p>
      </div>
      <Frame3 onBack={onBack} />
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[33px] leading-[0.5] left-[30px] not-italic text-[18px] text-black top-[78px] tracking-[-0.18px] w-[279px]">
      ...
      <div className="absolute flex h-[120.974px] items-center justify-center left-[12px] top-[624px] w-[127.501px]">
      ...
      <div className="absolute flex h-[169.866px] items-center justify-center left-[31px] top-[531.56px] w-[176.894px]">
        <div className="flex-none rotate-[41.054deg] skew-x-[359.421deg]">
      ...
      <div className="absolute flex h-[120.974px] items-center justify-center left-[212px] top-[641px] w-[127.501px]">
        <div className="flex-none rotate-[41.054deg] skew-x-[359.421deg]">
          <div className="h-[58.816px] relative w-[117.272px]" data-name="path60">
            <div className="absolute inset-[-29.75%_-14.92%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 153 95">
...
export default function Group27({ userName, onBack }) {
  ...
  return (
    <div className="relative bg-white h-[852px] left-0 overflow-clip top-0 w-[393px]">
      <Group26 
        userName={userName}
        onBack={onBack}
